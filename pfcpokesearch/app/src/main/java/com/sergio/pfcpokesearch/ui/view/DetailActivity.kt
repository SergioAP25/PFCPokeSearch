...
import com.sergio.pfcpokesearch.databinding.DetailActivityBinding
...
class DetailActivity: AppCompatActivity() {
    ...
    // Instancia del viewmodel con asignación
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Recoge la info pasada por el intent
        ...
        // Llama a la función onCreate del viewmodel
        pokemonDetailViewModel.onCreate(name)

        // Asigna un observer al pokemonModel
        pokemonDetailViewModel.pokemonModel.observe(context, Observer {pokemon ->
            // Lógica que asigna la información a la interfaz xml
